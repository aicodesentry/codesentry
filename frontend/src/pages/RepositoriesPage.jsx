...
export default function RepositoriesPage() {
  ...
  const visibleRepositoryCount = repositories.length
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-neutral-900 dark:text-white">Repositories</h1>
          <p className="text-sm text-neutral-500 dark:text-neutral-400">Connect repositories to start receiving PR reviews</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        {[
          { icon: Compass, value: visibleRepositoryCount, label: 'Visible repos' },
      ...
      {status.repositoryCount === 0 && status.installationCount > 0 && (
        <div className="rounded-xl border border-neutral-200 bg-white px-5 py-4 dark:border-neutral-800 dark:bg-neutral-900">
          <p className="text-sm font-medium text-neutral-900 dark:text-white">The app is installed, but GitHub has not granted repository access yet.</p>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-neutral-900 hover:underline dark:text-white"
          >
      ...
      <div>
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-neutral-900 dark:text-white">Repository roster</h2>
            ...
            {paginatedRepos.map((repo) => (
              ...
              >
                ...
                <Link to={`/dashboard/repositories/${repo.id}`} className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-neutral-900 dark:text-white truncate">{repo.full_name}</p>
                ...
                <div className="flex-shrink-0">
                  {repo.is_active ? (
                    <button
                      ...
                      className="rounded-lg border border-neutral-200 px-3 py-1.5 text-xs font-medium text-neutral-600 hover:bg-neutral-50 disabled:opacity-50 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-800"
                    >
                    ...
                    <button
                      ...
                      disabled={connecting === repo.id}
                      className="rounded-lg bg-neutral-900 px-3 py-1.5 text-xs font-medium text-white hover:bg-neutral-800 disabled:opacity-50 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-100"
                    >
